...
O.options = {
  ...
  armory = {
    ...
    type = "group",
    group = "tab",
    name = F.String.Menu.Armory() .. (TXUI.IsCata and F.String.Error(" [测试版]") or ""),
    desc = "配置角色界面军械库的所有选项",
  ...
  fonts = {
    ...
    desc = "配置各种 ElvUI 和 " .. TXUI.Title .. " 字体",
