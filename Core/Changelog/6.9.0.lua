...
TXUI.Changelog["6.9.0"] = {
  ...
  CHANGES = {
    ...
    "如果由于某些自定义文本未正确转换而遇到问题，请按照以下步骤操作:" .. F.String.Sublist("退出你的角色") .. F.String.Sublist(
      "在你的魔兽世界目录中打开此文件: WTF/Account/<ACCOUNT_ID>/SavedVariables/ElvUI.lua"
    ) .. F.String.Sublist("找到一行写着 " .. F.String.ToxiUI("[\"lastDBConversion\"] = \"6.9.0\"")) .. F.String.Sublist("将 6.9.0 更改为 6.8.8") .. F.String.Sublist(
      "保存文件并重新登录你的角色"
