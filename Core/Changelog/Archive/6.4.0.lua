...
TXUI.Changelog["6.4.0"] = {
  ...
  CHANGES = {
    ...
    F.String.GradientMode() .. F.String.Class(" class color") .. " font options for " .. TXUI.Title .. " " .. F.String.Menu.Armory(),
    F.String.GradientMode() .. " UnitFrame text tags in Dark Mode" .. F.String.Sublist("Credits to " .. F.String.Eltreum() .. " and " .. F.String.ElvUI("ElvUI discord")),
    F.String.GradientMode() .. " Details texts in Dark Mode" .. F.String.Sublist("Disabled by default") .. F.String.Sublist(
    ...
    TXUI.Title .. ": Update " .. F.String.GradientMode() .. "'s Energy colors to match Luxthos WA",
    TXUI.Title .. ": Update " .. F.String.GradientMode() .. "'s Mana colors to match Luxthos WA",
