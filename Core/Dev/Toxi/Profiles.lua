...
function T:SetupProfile()
  ...
  -- Class colors
  E.db.TXUI.themes.gradientMode.textures.health = "- Tx Half"
  E.db.TXUI.themes.gradientMode.textures.power = "- Bezo Darker"
  E.db.TXUI.themes.gradientMode.textures.cast = "- Tx Half"
