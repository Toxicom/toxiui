...
P.themes = {
  ...
  gradientMode = {
    ...
    classColorMap = {
      [I.Enum.GradientMode.Color.SHIFT] = { -- LEFT
        DEATHKNIGHT = F.Table.HexToRGB("#911622"),
        DEMONHUNTER = F.Table.HexToRGB("#8200a9"),
        DRUID = F.Table.HexToRGB("#e76200"),
        EVOKER = F.Table.HexToRGB("#33706f"),
        HUNTER = F.Table.HexToRGB("#4acc35"),
        MAGE = F.Table.HexToRGB("#0080d7"),
        MONK = F.Table.HexToRGB("#009463"),
        PALADIN = F.Table.HexToRGB("#d960a4"),
        PRIEST = F.Table.HexToRGB("#b9bddb"),
        ROGUE = F.Table.HexToRGB("#e7b200"),
        SHAMAN = F.Table.HexToRGB("#0061bf"),
        WARLOCK = F.Table.HexToRGB("#562fbd"),
        WARRIOR = F.Table.HexToRGB("#946837"),
      },
      [I.Enum.GradientMode.Color.NORMAL] = { -- RIGHT
        DEATHKNIGHT = F.Table.HexToRGB("#ff2855"),
        DEMONHUNTER = F.Table.HexToRGB("#e500d1"),
        DRUID = F.Table.HexToRGB("#ffa900"),
        EVOKER = F.Table.HexToRGB("#32fedc"),
        HUNTER = F.Table.HexToRGB("#abed4f"),
        MAGE = F.Table.HexToRGB("#00d8ff"),
        MONK = F.Table.HexToRGB("#00ff8c"),
        PALADIN = F.Table.HexToRGB("#ff95d8"),
        PRIEST = F.Table.HexToRGB("#f2f4ff"),
        ROGUE = F.Table.HexToRGB("#f5ee5a"),
        SHAMAN = F.Table.HexToRGB("#0a7ded"),
        WARLOCK = F.Table.HexToRGB("#9946ff"),
        WARRIOR = F.Table.HexToRGB("#dfaa73"),
      },
    },
  },
}
