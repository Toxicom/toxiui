...
I.Enum.Requirements = F.Enum {
  ...
  "AB_BUDDY_DISABLED",
  "ELTRUISM_DISABLED",
  "BETTER_COOLDOWN_MANAGER_DISABLED",
  "COOLDOWN_MANAGER_CENTERED_DISABLED",
  "DETAILS_ADDON_DISABLED",
  "ELVUI_DAMAGE_METER_SKIN_ENABLED",
}
...
-- Client Flavors
I.Enum.Flavor = F.Enum { "CLASSIC_ERA", "CLASSIC", "RETAIL", "ANNIVERSARY" }
